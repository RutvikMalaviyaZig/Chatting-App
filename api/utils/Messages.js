const MESSAGES = {
    ...
    ROOM_CREATED : 'Room created succesfully',
    ROOM_NOT_FOUND : 'Room not found ',
    ALLREADY_IN_ROOM : 'You are Allready in the room',
    JOIN_ROOM : 'join Room successfully',
    MESSAGES_CREATED : 'message create successfully',
